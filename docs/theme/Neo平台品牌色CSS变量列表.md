...
| CSS 变量 | 默认色值 | -rgb 伴侣变量 | 说明 |
|:--|:--|:--|:--|
| `--brand-color` | `#0564f5` | `--brand-color-rgb: 5, 100, 245` | 品牌主色，所有品牌色体系的根源 |
| `--brand-color-hover` | `#1a7aff` | `--brand-color-hover-rgb: 26, 122, 255` | 品牌 Hover 色，各元素 hover 交互态 |
| `--brand-color-shade` | `#004ccf` | `--brand-color-shade-rgb: 0, 76, 207` | 品牌深色变体，active / 按下 / 选中态 |
| `--brand-color-tint` | `#e6f4ff` | `--brand-color-tint-rgb: 230, 244, 255` | 品牌最浅变体，大面积背景底色 |
| `--brand-color-tint-light` | `#a8d7ff` | `--brand-color-tint-light-rgb: 168, 215, 255` | 品牌次浅变体，浅色背景 / hover 背景 |
| `--brand-color-disabled` | `#80bfff` | `--brand-color-disabled-rgb: 128, 191, 255` | 品牌禁用态 |
...
| CSS 变量 | 级联自 | 说明 |
|:--|:--|:--|
| `--color-bg-brand` | `var(--brand-color)` | 品牌主色背景，强品牌感区块底色 |
| `--color-bg-brand-hover` | `var(--brand-color-hover)` | 品牌 Hover 背景 |
| `--color-bg-brand-shade` | `var(--brand-color-shade)` | 品牌深色背景，重点强调区域 |
| `--color-bg-brand-tint` | `var(--brand-color-tint)` | 品牌浅色背景，卡片 / 选中行轻量底色 |
| `--color-bg-brand-tint-light` | `var(--brand-color-tint-light)` | 品牌次浅色背景 |
| `--color-bg-brand-disabled` | `var(--brand-color-disabled)` | 品牌禁用态背景 |
...
| CSS 变量 | 级联自 | 说明 |
|:--|:--|:--|
| `--color-border-brand` | `var(--brand-color)` | 品牌主色边框，input focus / 选中边框 |
| `--color-border-brand-hover` | `var(--brand-color-hover)` | 品牌 Hover 边框 |
| `--color-border-brand-shade` | `var(--brand-color-shade)` | 品牌深色边框 |
| `--color-border-brand-tint` | `var(--brand-color-tint)` | 品牌浅色边框 |
| `--color-border-brand-tint-light` | `var(--brand-color-tint-light)` | 品牌次浅色边框 |
| `--color-border-brand-disabled` | `var(--brand-color-disabled)` | 品牌禁用态边框 |
...
| CSS 变量 | 级联自 | 说明 |
|:--|:--|:--|
| `--color-icon-brand` | `var(--brand-color)` | 图标主色，功能图标正常态 |
| `--color-icon-brand-hover` | `var(--brand-color-hover)` | 图标 Hover 色 |
| `--color-icon-brand-shade` | `var(--brand-color-shade)` | 图标深色，active 态 |
| `--color-icon-brand-tint` | `var(--brand-color-tint)` | 图标浅色 |
| `--color-icon-brand-tint-light` | `var(--brand-color-tint-light)` | 图标次浅色 |
| `--color-icon-fill-brand-link` | `var(--brand-color-shade)` | 图标链接色，可点击图标 hover 交互色 |
| `--color-icon-brand-disabled` | `var(--brand-color-disabled)` | 图标禁用色 |
...
| CSS 变量 | 级联自 | 说明 |
|:--|:--|:--|
| `--color-text-brand` | `var(--brand-color)` | 品牌色文字，关键数据 / 主标题 / 链接基础色 |
| `--color-text-brand-hover` | `var(--brand-color-hover)` | 品牌 Hover 文字色 |
| `--color-text-brand-shade` | `var(--brand-color-shade)` | 品牌深色文字，链接 active 态 |
| `--color-text-brand-tint` | `var(--brand-color-tint)` | 品牌浅色文字底 |
| `--color-text-brand-tint-light` | `var(--brand-color-tint-light)` | 品牌次浅色文字 |
| `--color-text-brand-disabled` | `var(--brand-color-disabled)` | 品牌禁用态文字色 |
| `--color-text-brand-link` | `var(--brand-color-shade)` | 文字链接色，hover 加深效果 |
...
| CSS 变量 | 级联自 | 说明 |
|:--|:--|:--|
| `--color-button-filled-primary` | `var(--color-bg-brand)` | 正常态背景色（★ 同时可用于 border/outline/text 颜色） |
| `--color-button-filled-primary-hover` | `var(--color-bg-brand-hover)` | 鼠标悬停背景色 |
| `--color-button-filled-primary-active` | `var(--color-bg-brand-shade)` | 点击按下背景色 |
| `--color-button-filled-primary-tint` | `var(--color-bg-brand-tint)` | 浅色背景 |
| `--color-button-filled-primary-disabled` | `var(--color-bg-brand-disabled)` | 禁用态背景色 |
...
| CSS 变量 | 说明 |
|:--|:--|
| `--brand-nav-header-bg` | 导航栏背景色 |
| `--brand-nav-header-font` | 导航栏标题 / 正文文字色（自动识别深浅色） |
| `--brand-nav-header-font-hover` | 导航栏文字 Hover 态 |
| `--brand-nav-header-icon` | 导航栏图标色（返回 / 关闭等） |
| `--brand-nav-header-icon-hover` | 导航栏图标 Hover 态 |
| `--brand-nav-header-launcher-icon` | 启动器图标色（使用品牌色） |
| `--brand-nav-header-select` | 选中项高亮色（使用品牌深色变体） |
| `--brand-nav-header-select-bg` | 导航栏选中项背景色 |
| `--brand-nav-header-elem-opacity` | 导航元素半透明层 |
| `--brand-nav-header-elem-hover` | 导航元素悬停背景色 |
| `--brand-nav-header-placeholder` | 导航栏输入框占位符色 |
