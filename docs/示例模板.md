...
| `entityCardList__c` | 实体数据卡片列表 | 实体信息卡片列表，展示用户姓名、手机号等信息 | web | `template/neo-custom-cmp-template/src/components/entityCardList__c/` |
...
- `entityCardList__c` / `entityTable__c`：通过 `xObjectDataApi` 绑定实体数据源和字段列表
...
| cmpType | 组件名称 | 终端 | 技术栈 | 模板目录 |
|---|---|---|---|---|
| `dataDashboard__c` | 数据仪表板 | web | React + TS + Ant Design | antd-custom-cmp-template |
| `searchWidget__c` | 搜索组件 | web | React + TS + Ant Design | antd-custom-cmp-template |
| `chartWidget__c` | 酷炫图表组件 | web | React + TS + ECharts | echarts-custom-cmp-template |
| `mapWidget__c` | 地图组件 | web | React + TS + 高德地图 | map-custom-cmp-template |
| `targetNumber__c` | 数值指标 | all | React + TS | neo-bi-cmps |
| `filterBar__c` | 筛选栏 | all | React + TS | neo-bi-cmps |
| `simpleCmp__c` | 简单示例组件 | web | React + TS | neo-custom-cmp-template |
| `customApi__c` | 自定义API示例 | web | React + TS | neo-custom-cmp-template |
| `entityCardList__c` | 实体数据卡片列表 | web | React + TS | neo-custom-cmp-template |
| `entityDetail__c` | 实体数据详情 | web | React + TS | neo-custom-cmp-template |
| `entityForm__c` | 实体表单 | web | React + TS | neo-custom-cmp-template |
| `entityTable__c` | 实体数据表格 | web | React + TS | neo-custom-cmp-template |
| `chatPage__c` | chatPage | mobile | React + TS | neo-h5-cmps |
| `entityList__c` | 数据列表 | mobile | React + TS | neo-h5-cmps |
| `globalSearchInput__c` | 全局搜索组件 | mobile | React + TS | neo-h5-cmps |
| `openChatPageBtn__c` | 打开AI对话框 | all | React + TS | neo-h5-cmps |
| `entityTabs__c` | 数据列表Tabs | mobile | React + TS | neo-h5-cmps |
| `entityInfoCard__c` | 实体信息展示卡片 | web | React + TS | neo-order-cmps |
| `simpleTable__c` | 实体数据表格（简化版） | web | React + TS | neo-order-cmps |
| `entityGrid__c` | 基础大列表 | web | React + TS | neo-web-entity-grid |
| `entityGrid2__c` | 自定义筛选列表 | web | React + TS | neo-web-entity-grid |
| `entityGrid3__c` | Picker列表 | web | React + TS | neo-web-entity-grid |
| `entityGrid4__c` | 大列表/自定义工具栏 | web | React + TS | neo-web-entity-grid |
| `createForm__c` | 新增数据表单 | web | React + TS | neo-web-entity-grid |
| `searchForm__c` | 自定义查询表单 | web | React + TS | neo-web-entity-grid |
| `batchAddTable__c` | 批量新增表格 | web | React + TS | neo-web-form |
| `listSummary__c` | 列表汇总 | web | React + TS | neo-web-form |
| `infoCard__c` | 信息卡片 | web | React + JS | react-custom-cmp-template |
| `listWidget__c` | 列表组件 | web | React + TS | react-ts-custom-cmp-template |
| `vueInfoCard__c` | vue 信息卡片 | web | Vue 2 + JS | vue2-custom-cmp-template |
