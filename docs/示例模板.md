...
```bash
neo init --template neo-custom-cmp-template
```
...
```bash
neo init --template neo-web-entity-grid
```
...
```bash
neo init --template neo-web-form
```
...
```bash
# 基于此模板创建新项目
neo init --template antd-custom-cmp-template
```
...
```bash
neo init --template echarts-custom-cmp-template
```
...
```bash
neo init --template map-custom-cmp-template
```
...
```bash
neo init --template neo-order-cmps
```
...
```bash
neo init --template react-custom-cmp-template
```
...
```bash
neo init --template react-ts-custom-cmp-template
```
...
```bash
neo init --template vue2-custom-cmp-template
```
