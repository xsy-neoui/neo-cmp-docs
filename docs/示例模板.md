...
| cmpType | 组件名称 | 终端 | 技术栈 | 模板目录 | <div style="width: 200px; white-space: normal; word-break: break-word">描述</div> |
|---|---|---|---|---|---|
| `simpleCmp__c` | 简单示例组件 | web | React + TS | neo-custom-cmp-template | <div style="width: 200px; white-space: normal; word-break: break-word">简单示例组件，适合快速上手</div> |
| `infoCard__c` | 信息卡片 | web | React + JS | react-custom-cmp-template | <div style="width: 200px; white-space: normal; word-break: break-word">React 简版信息展示卡片</div> |
| `vueInfoCard__c` | vue 信息卡片 | web | Vue 2 + JS | vue2-custom-cmp-template | <div style="width: 200px; white-space: normal; word-break: break-word">Vue2 版信息展示卡片</div> |
| `targetNumber__c` | 数值指标 | all | React + TS | neo-bi-cmps | <div style="width: 200px; white-space: normal; word-break: break-word">关键数值指标展示卡片，支持从 XObject 实体对象获取动态数据，支持绑定多个字段进行展示</div> |
| `filterBar__c` | 筛选栏 | all | React + TS | neo-bi-cmps | <div style="width: 200px; white-space: normal; word-break: break-word">筛选工具栏，支持日期范围、负责人、业务类型等多维度筛选</div> |
| `entityDetail__c` | 实体数据详情 | web | React + TS | neo-custom-cmp-template | <div style="width: 200px; white-space: normal; word-break: break-word">实体详情信息展示，支持多列布局</div> |
| `entityForm__c` | 实体表单 | web | React + TS | neo-custom-cmp-template | <div style="width: 200px; white-space: normal; word-break: break-word">基于 XObject 的实现的对象表单组件，可用于新增实体业务数据</div> |
| `entityTable__c` | 实体数据表格 | web | React + TS | neo-custom-cmp-template | <div style="width: 200px; white-space: normal; word-break: break-word">基于 XObject 实现的实体数据表格组件，支持实体数据的增删改查操作</div> |
| `customApi__c` | 自定义API示例 | web | React + TS | neo-custom-cmp-template | <div style="width: 200px; white-space: normal; word-break: break-word">通过通用代理请求外部数据接口，并以表格形式展示外部接口数据</div> |
| `chatPage__c` | chatPage | mobile | React + TS | neo-h5-cmps | <div style="width: 200px; white-space: normal; word-break: break-word">chatPage 智能对话组件</div> |
| `entityList__c` | 数据列表 | mobile | React + TS | neo-h5-cmps | <div style="width: 200px; white-space: normal; word-break: break-word">基于平台 entityList 实现的实体数据列表组件</div> |
| `globalSearchInput__c` | 全局搜索组件 | mobile | React + TS | neo-h5-cmps | <div style="width: 200px; white-space: normal; word-break: break-word">基于平台 GlobalSearchInput 实现的全局搜索组件</div> |
| `openChatPageBtn__c` | 打开AI对话框 | all | React + TS | neo-h5-cmps | <div style="width: 200px; white-space: normal; word-break: break-word">可用于打开 AI 对话页的按钮</div> |
| `entityTabs__c` | 数据列表Tabs | mobile | React + TS | neo-h5-cmps | <div style="width: 200px; white-space: normal; word-break: break-word">基于平台 H5端 entityList 实现的数据列表 Tabs 组件</div> |
| `entityInfoCard__c` | 实体信息展示卡片 | web | React + TS | neo-order-cmps | <div style="width: 200px; white-space: normal; word-break: break-word">基于 xObject 实现的简版实体信息展示卡片，以网格布局展示实体数据信息</div> |
| `simpleTable__c` | 实体数据表格（简化版） | web | React + TS | neo-order-cmps | <div style="width: 200px; white-space: normal; word-break: break-word">基于 XObject 实现的数据表格组件，仅支持数据展示，不支持增删改查操作</div> |
| `entityGrid__c` | 基础大列表 | web | React + TS | neo-web-entity-grid | <div style="width: 200px; white-space: normal; word-break: break-word">基于平台 NeoEntityGrid 实现的数据列表，支持视图切换、搜索、新增、导出、分页等显隐控制</div> |
| `entityGrid2__c` | 自定义筛选列表 | web | React + TS | neo-web-entity-grid | <div style="width: 200px; white-space: normal; word-break: break-word">基于平台 NeoEntityGrid 实现，支持自定义表单筛选 + 大列表实时响应联动</div> |
| `entityGrid3__c` | Picker列表 | web | React + TS | neo-web-entity-grid | <div style="width: 200px; white-space: normal; word-break: break-word">基于平台 NeoEntityGrid 实现的 Picker 列表模式数据选择器，支持单选和多选，不在设计器中直接展示</div> |
| `entityGrid4__c` | 大列表/自定义工具栏 | web | React + TS | neo-web-entity-grid | <div style="width: 200px; white-space: normal; word-break: break-word">基于平台 NeoEntityGrid 实现，支持自定义工具栏</div> |
| `createForm__c` | 新增数据表单 | web | React + TS | neo-web-entity-grid | <div style="width: 200px; white-space: normal; word-break: break-word">用于创建实体业务数据的表单组件</div> |
| `searchForm__c` | 自定义查询表单 | web | React + TS | neo-web-entity-grid | <div style="width: 200px; white-space: normal; word-break: break-word">对象数据查询表单，用于设置自定义筛选条件</div> |
| `batchAddTable__c` | 批量新增表格 | web | React + TS | neo-web-form | <div style="width: 200px; white-space: normal; word-break: break-word">批量新增数据组件，支持逐行录入与 Excel 批量导入</div> |
| `listSummary__c` | 列表汇总 | web | React + TS | neo-web-form | <div style="width: 200px; white-space: normal; word-break: break-word">通过组件动作接收列表数据后展示商品总数与金额汇总，支持绑定实体、数量和金额字段</div> |
| `dataDashboard__c` | 数据仪表板 | web | React + TS + Ant Design | antd-custom-cmp-template | <div style="width: 200px; white-space: normal; word-break: break-word">使用 antd ui 组件实现的数据展示仪表板，支持动态数据更新和动画效果</div> |
| `searchWidget__c` | 搜索组件 | web | React + TS + Ant Design | antd-custom-cmp-template | <div style="width: 200px; white-space: normal; word-break: break-word">使用 antd ui 组件实现的支持搜索输入，点击回车键显示搜索内容</div> |
| `chartWidget__c` | 酷炫图表组件 | web | React + TS + ECharts | echarts-custom-cmp-template | <div style="width: 200px; white-space: normal; word-break: break-word">使用 echarts 实现的图表组件，支持多种图表类型切换，支持丰富的配置选项</div> |
| `mapWidget__c` | 地图组件 | web | React + TS + 高德地图 | map-custom-cmp-template | <div style="width: 200px; white-space: normal; word-break: break-word">使用高德地图实现的地图区域展示组件，支持传入经纬度或地址名称</div> |
| `listWidget__c` | 列表组件 | web | React + TS | react-ts-custom-cmp-template | <div style="width: 200px; white-space: normal; word-break: break-word">自定义列表展示组件</div> |
